                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-8 space-y-4">
                        ...
                        <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-between">
                            ...
                            <!-- Checkout button -->
                            <a href="{{ route('checkout.shipping') }}" class="w-full sm:w-auto px-6 py-2 text-white bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 rounded-md transition duration-150 ease-in-out shadow-sm flex items-center justify-center">
